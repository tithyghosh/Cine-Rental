...
const CartDetails = ({onClose}) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 w-screen h-screen z-50 backdrop-blur-sm"
    >
      <div
      ...
      >
        ...
        >
          ...
          >
            ...
            cartData.length === 0 ? (
              <p className="text-center text-[#6F6F6F] text-xl">Your cart is empty.</p>
            ) : ( cartData.map(item => (
          ...
          <div className="flex items-center justify-end gap-2">
            <a  
              className="rounded-md p-2 md:px-4 inline-flex items-center space-x-2 bg-[#00D991] text-[#171923] text-sm"
              href="#"
            >
